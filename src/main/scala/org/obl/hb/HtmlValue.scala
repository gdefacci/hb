...
class HtmlValue[T](_value: Option[T]) extends BaseOptionalValue(_value, (t:T) => ValueRenderer.render(t)) {
  protected def emptyValue = ""
}

object ValuesSet {
  private def defaultFormatter[T]:T => String = (t:T) => ValueRenderer.render(t)
